...
//  chizhiks per coconut. Sasha has x
//  chizhiks, Masha has y
...
//  chizhiks, Masha has 4
//  chizhiks, and the price for one coconut be 3
//  chizhiks. If the girls don't exchange with chizhiks, they will buy 1+1=2
//  coconuts. However, if, for example, Masha gives Sasha one chizhik, then Sasha will have 6
//  chizhiks, Masha will have 3
//  chizhiks, and the girls will buy 2+1=3
//  coconuts.
